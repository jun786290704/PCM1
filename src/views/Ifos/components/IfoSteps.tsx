    ...
    <CardBody>
      ...
      <Box>
        <Text color="textSubtle" small>
          {t(
            'The maximum amount of PCM user can commit to the Public Sale, is equal to the average PCM balance in the IFO PCM pool prior to the IFO. Stake more PCM to increase the maximum PCM you can commit to the sale. Missed this IFO? You can keep staking in the IFO PCM Pool to join the next IFO sale.',
          )}
        </Text>
