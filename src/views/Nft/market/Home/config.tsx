import { LinkExternal } from '@pcmswap/uikit'
  ...
  return [
    ...
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.pcmswap.info/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by PancakeSwap from sales are used to buy back and BURN PCM tokens in our weekly PCM burns.',
        ),
        t(
