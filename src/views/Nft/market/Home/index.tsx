...
import { Box, Button, Flex, Heading, LinkExternal } from '@pcmswap/uikit'
  ...
  return (
    <>
      ...
      <Gradient p="64px 0">
        ...
        <LinkExternal href="https://docs.pcmswap.info/contact-us/nft-market-applications" mx="auto" mt="16px">
