import { Box, Flex, HelpIcon, Skeleton, Text, useMatchBreakpoints, useTooltip } from '@pcmswap/uikit'
...
const IFOCreditCell: React.FC<IFOCreditCellProps> = ({ account }) => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Text>
        {t(
          'Your entry limit in the next IFO Public Sale is determined by your IFO credit. This is calculated by the average PCM balance of the principal amount in the IFO pool during the last credit calculation period.',
        )}
      </Text>
      <Text>
        {t(
