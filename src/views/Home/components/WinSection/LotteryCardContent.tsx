...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@pcmswap/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in PCM prizes this round', { cakePrizeInUsd: cakePriceBusd.toString() })
