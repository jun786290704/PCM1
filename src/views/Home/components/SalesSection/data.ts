...
export const earnSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t('PCMSwap makes it easy to make your crypto work for you.'),
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: t('Explore'),
...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  headingText: t('PCM makes our world go round.'),
  bodyText: t(
  ...
  secondaryButton: {
    to: 'https://docs.pcmswap.info/tokenomics/cake',
    text: t('Learn'),
    external: true,
  },
