...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and PCM pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and PCM pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from PCM pool', data)
  }
