...
import { ConnectorNames, connectorLocalStorageKey, Text, Box, LinkExternal } from '@pcmswap/uikit'
            ...
            if (error instanceof NoEthereumProviderError || error instanceof NoBscProviderError) {
              toastError(
                ...
                <Box>
                  ...
                  <LinkExternal href="https://docs.pcmswap.info/get-started/connection-guide">
                    {t('Need help ?')}
                  </LinkExternal>
                </Box>,
              )
