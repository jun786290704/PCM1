import { ChainId, JSBI, Percent, Token } from '@pcmswap/sdk'
...
export const EXCHANGE_DOCS_URLS = 'https://docs.pcmswap.info/products/pancakeswap-exchange'
export const LIMIT_ORDERS_DOCS_URL = 'https://docs.pcmswap.info/products/pancakeswap-exchange/limit-orders'
